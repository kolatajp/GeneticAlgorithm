...
public class GeneticAlgorithmRemote extends UnicastRemoteObject implements GeneticAlgorithmInterface {
    ...
    public GeneticAlgorithmRemote() throws RemoteException {
    }

    public String getBestSerial() throws RemoteException {
        return this.getBest().serial();
    }

    public GeneticAlgorithmRemote( TestingFunction function, double crossBreedProbability,
    ...
    public void setFunction( String fname ) {
        if ( fname.equals( "beales" ) ) {
            //deb
            System.out.println( "Beales" );
            this.function = new BealesFunction();
        } else if ( fname.equals( "booths" ) ) {
            this.function = new BoothsFunction();
            //deb
            System.out.println( "Booth" );
        } else if ( fname.equals( "bunkin" ) ) {
            this.function = new BunkinFunctionN6();
            //deb
            System.out.println( "Bunking" );
        } else if ( fname.equals( "rosenbrock" ) ) {
            this.function = new RosenbrockFunction();
            //deb
